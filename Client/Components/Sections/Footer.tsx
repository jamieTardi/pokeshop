...
import { FacebookOutlined, YouTube, Twitter, Instagram } from "@mui/icons-material";
...
const logos = [
	...
	<a href="https://www.instagram.com/poke.decks.uk/" className={styles.footerSVG}>
		<Instagram key={4} />
	</a>,
];
		...
		<div style={{ position: "relative", width: "90%" }}>
			<div className={styles.footerGrid}>
				...
				<div className={styles.footerGridItem2}>
					...
					<ul>
						<li>
							<a href="/Cookie-Policy-Poke-Decks.pdf" rel="noopener noreferrer" download>
								Cookie Policy
							</a>
						</li>
						<li>
				...
				<div className={styles.footerGridItem3}>
					...
					<ul>
						<li>
							<a href="/Terms_and_Conditions.pdf" rel="noopener noreferrer" download>
